		...
		<div class="site-footer__grid">
			...
			<div class="site-footer__column site-footer__contacts">
				...
				<p>
					...
					<a href="tel:+74951176337">+7 (495) 117-63-37</a>
				</p>
				...
				<p>
					...
					<?php _e( 'г. Подольск, Московская область', 'shumoff' ); ?>
				</p>

				<p>
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
					<a href="mailto:info@shumoffpodolsk.com">info@shumoffpodolsk.com</a>
				</p>

				<p>
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
					<?php _e( 'Пн–Сб: 9:00–20:00, Вс — выходной', 'shumoff' ); ?>
				</p>

				<!-- Social Links -->
				<div class="site-footer__socials">
					<a href="https://wa.me/74951176337" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" title="Написать в WhatsApp">
					...
					<a href="https://t.me/shumoffpodolsk" target="_blank" rel="noopener noreferrer" aria-label="Telegram" title="Написать в Telegram">
