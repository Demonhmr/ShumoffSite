...
<main class="page-content">
	<div class="single-template-content">
		...
		if ( have_posts() ) :
			while ( have_posts() ) :
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					$materials     = shumoff_field( 'case_materials' );
		...
		get_template_part( 'template-parts/appointment-form', null, array(
			'title' => __( 'Хотите такой же результат?', 'shumoff' ),
			'text'  => __( 'Запишитесь на шумоизоляцию — мы добьёмся такого же эффекта для вашего автомобиля!', 'shumoff' ),
		) );
		?>
